...
public class start {
	...
	public static void out(String text) {
		JOptionPane.showMessageDialog(/*gui.ioPanel*/null, text, title+" - Story", JOptionPane.PLAIN_MESSAGE);
		//gui.pack();
	}
	...
	public static String mchoice(String question/* , String title */, String... options) {
		return (String) JOptionPane.showInputDialog(null, question, title+" - A Choice", JOptionPane.PLAIN_MESSAGE, null,
				options, options[0]);
	}

	public static String getStr(String question/* , String title */) {
		return (String) JOptionPane.showInputDialog(null, question, title+" - Input", JOptionPane.PLAIN_MESSAGE, null, null,
				null);
	}

	public static int getInt(String question/* , String title */) {
		return Integer.parseInt((String) JOptionPane.showInputDialog(null, question, title+" - Input", JOptionPane.PLAIN_MESSAGE,
				null, null, null));
	}
